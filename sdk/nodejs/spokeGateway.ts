...
export class SpokeGateway extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpokeGatewayState, opts?: pulumi.CustomResourceOptions): SpokeGateway {
        return new SpokeGateway(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/spokeGateway:SpokeGateway';

    /**
     * Returns true if the given object is an instance of SpokeGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SpokeGateway {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SpokeGateway.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SpokeGatewayArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SpokeGatewayArgs | SpokeGatewayState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SpokeGatewayState | undefined;
            ...
            const args = argsOrState as SpokeGatewayArgs | undefined;
        ...
        super(SpokeGateway.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SpokeGatewayState {
    /**
     * This parameter represents the name of a Cloud-Account in Aviatrix controller.
     */
 ...
 */
export interface SpokeGatewayArgs {
    /**
     * This parameter represents the name of a Cloud-Account in Aviatrix controller.
     */
    accountName: pulumi.Input<string>;
