...
class TransitGatewayArgs:
    def __init__(__self__, *,
                 ...
                 bgp_lan_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayBgpLanInterfaceArgs']]]] = None,
                 ...
                 ha_bgp_lan_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayHaBgpLanInterfaceArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TransitGatewayBgpLanInterfaceArgs']]] bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP Transit.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TransitGatewayHaBgpLanInterfaceArgs']]] ha_bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP HA Transit.
    ...
    def bgp_lan_interfaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayBgpLanInterfaceArgs']]]]:
        """
    ...
    def bgp_lan_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayBgpLanInterfaceArgs']]]]):
    ...
    def ha_bgp_lan_interfaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayHaBgpLanInterfaceArgs']]]]:
        """
        Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
        for GCP HA Transit.
        """
    ...
    def ha_bgp_lan_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TransitGatewayHaBgpLanInterfaceArgs']]]]):
...
class _TransitGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TransitGatewayBgpLanInterfaceArgs']]] bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP Transit.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] bgp_lan_ip_lists: List of available BGP LAN interface IPs for transit external device connection creation. Only supports GCP. Available as
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TransitGatewayHaBgpLanInterfaceArgs']]] ha_bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP HA Transit.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ha_bgp_lan_ip_lists: List of available BGP LAN interface IPs for transit external device HA connection creation. Only supports GCP. Available
...
class TransitGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bgp_ecmp: Optional[pulumi.Input[bool]] = None,
                 bgp_hold_time: Optional[pulumi.Input[int]] = None,
                 bgp_lan_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TransitGatewayBgpLanInterfaceArgs']]]]] = None,
                 bgp_manual_spoke_advertise_cidrs: Optional[pulumi.Input[str]] = None,
                 bgp_polling_time: Optional[pulumi.Input[str]] = None,
                 cloud_type: Optional[pulumi.Input[int]] = None,
                 connected_transit: Optional[pulumi.Input[bool]] = None,
                 ...
                 ha_availability_domain: Optional[pulumi.Input[str]] = None,
                 ha_azure_eip_name_resource_group: Optional[pulumi.Input[str]] = None,
                 ha_bgp_lan_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TransitGatewayHaBgpLanInterfaceArgs']]]]] = None,
                 ha_eip: Optional[pulumi.Input[str]] = None,
                 ha_fault_domain: Optional[pulumi.Input[str]] = None,
                 ha_gw_size: Optional[pulumi.Input[str]] = None,
                 ha_image_version: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[bool] bgp_ecmp: Enable Equal Cost Multi Path (ECMP) routing for the next hop.
        :param pulumi.Input[int] bgp_hold_time: BGP Hold Time.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TransitGatewayBgpLanInterfaceArgs']]]] bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP Transit.
        :param pulumi.Input[str] bgp_manual_spoke_advertise_cidrs: Intended CIDR list to be advertised to external bgp router.
        :param pulumi.Input[str] bgp_polling_time: BGP route polling time. Unit is in seconds. Valid values are between 10 and 50.
        :param pulumi.Input[int] cloud_type: Type of cloud service provider, requires an integer value. Use 1 for AWS.
        ...
        :param pulumi.Input[str] ha_availability_domain: HA availability domain for OCI.
        :param pulumi.Input[str] ha_azure_eip_name_resource_group: The name of the public IP address and its resource group in Azure to assign to the HA Transit Gateway.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TransitGatewayHaBgpLanInterfaceArgs']]]] ha_bgp_lan_interfaces: Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
               for GCP HA Transit.
        :param pulumi.Input[str] ha_eip: Public IP address that you want assigned to the HA Transit Gateway.
        :param pulumi.Input[str] ha_fault_domain: HA fault domain for OCI.
        :param pulumi.Input[str] ha_gw_size: HA Gateway Size. Mandatory if HA is enabled (ha_subnet is set).
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[str]] = None,
            vpc_reg: Optional[pulumi.Input[str]] = None,
            zone: Optional[pulumi.Input[str]] = None) -> 'TransitGateway':
        """
    ...
    @property
    @pulumi.getter(name="bgpLanInterfaces")
    def bgp_lan_interfaces(self) -> pulumi.Output[Optional[Sequence['outputs.TransitGatewayBgpLanInterface']]]:
        """
        Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
        for GCP Transit.
        """
    ...
    @property
    @pulumi.getter(name="haBgpLanInterfaces")
    def ha_bgp_lan_interfaces(self) -> pulumi.Output[Optional[Sequence['outputs.TransitGatewayHaBgpLanInterface']]]:
        """
        Interfaces to run BGP protocol on top of the ethernet interface, to connect to the onprem/remote peer. Only available
        for GCP HA Transit.
        """
