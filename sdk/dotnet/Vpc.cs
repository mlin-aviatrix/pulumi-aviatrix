...
{
    [AviatrixResourceType("aviatrix:index/vpc:Vpc")]
    public partial class Vpc : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.VpcPrivateSubnet>> PrivateSubnets { get; private set; } = null!;

        /// <summary>
        /// List of public subnet of the VPC to be created.
        /// </summary>
        [Output("publicSubnets")]
        public Output<ImmutableArray<Outputs.VpcPublicSubnet>> PublicSubnets { get; private set; } = null!;
        ...
        public Vpc(string name, VpcArgs args, CustomResourceOptions? options = null)
            : base("aviatrix:index/vpc:Vpc", name, args ?? new VpcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vpc(string name, Input<string> id, VpcState? state = null, CustomResourceOptions? options = null)
            : base("aviatrix:index/vpc:Vpc", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class VpcState : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.VpcPrivateSubnetGetArgs>? _privateSubnets;

        /// <summary>
        /// List of private subnet of the VPC to be created.
        /// </summary>
        public InputList<Inputs.VpcPrivateSubnetGetArgs> PrivateSubnets
        {
            get => _privateSubnets ?? (_privateSubnets = new InputList<Inputs.VpcPrivateSubnetGetArgs>());
            set => _privateSubnets = value;
        }

        [Input("publicSubnets")]
        private InputList<Inputs.VpcPublicSubnetGetArgs>? _publicSubnets;

        /// <summary>
        /// List of public subnet of the VPC to be created.
        /// </summary>
        public InputList<Inputs.VpcPublicSubnetGetArgs> PublicSubnets
        {
            get => _publicSubnets ?? (_publicSubnets = new InputList<Inputs.VpcPublicSubnetGetArgs>());
