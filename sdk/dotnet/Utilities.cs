...
namespace Pulumi.Aviatrix
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Aviatrix.version.txt");
    ...
    internal sealed class AviatrixResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AviatrixResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
